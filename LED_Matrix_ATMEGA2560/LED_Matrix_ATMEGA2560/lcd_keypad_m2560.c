/* lcd_keypad_m2560.c
 * C driver for SainSmart "LCD Keypad" shield on a Mega2560 board
 *  V1.1  (c) 2015-2016  Matthias Meier
 * Derived from Arduino C++ keypad_lcd library (LCD4Bit_mod.cpp)
 * Remark: unfortunately neither the author nor the license condition are known for the Arduino lcd_keypad library
*/
